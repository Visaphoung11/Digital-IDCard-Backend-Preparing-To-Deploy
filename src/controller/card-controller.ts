...
export const updateCardController = async (req: Request, res: Response): Promise<void> => {
  const result = await updateCardService(req, res);
  res.status(201).json(result);
};

export const deleteCardUserController = async (req: Request, res: Response): Promise<void> => {
  const result = await deleteCardUserService(req, res);
  res.status(201).json(result);
};

export const getCardsUserController = async (req: Request, res: Response): Promise<void> => {
...
export const getCardByIdController = async (req: Request, res: Response): Promise<void> => {
